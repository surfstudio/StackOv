...
//  https://gist.github.com/322338df8a5220d649ac01ff11e7de12.git
//
//
...
public extension HTTPStatusCode {
    ...
    var localizedDescription: String {
        ...
        case .temporaryRedirect:
            return "The request should be repeated with another URI."
        ...
        case .gone:
            return "The resource requested is no longer available and will not be available again."
        case .lengthRequired:
        ...
        case .noResponse:
            return "Used to indicate that the server has returned no information to the client and closed the connection."
